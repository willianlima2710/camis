var cadlocpagto = Ext.extend(Ext.Window,{	
		 locpagtoID  : 0
		,modal		 : true
		,constrain	 : true
		,maximizable : false
		...
		,width		 : 450
		,height		 : 300
		,title		 : 'Cadastro de local de pagamento'
		,layout		 : 'fit'
		,buttonAlign : 'center'		
		,closeAction : 'hide'
			
		,setLocpagtoID: function(locpagtoID)
		{
			this.locpagtoID = locpagtoID;
		}
		,constructor: function()
		{
			...
			//super
			cadlocpagto.superclass.constructor.apply(this, arguments);
		}
		...
		,initComponent: function()
		{
			...
			//super
			cadlocpagto.superclass.initComponent.call(this);
		}
		,show: function()
		{
			cadlocpagto.superclass.show.apply(this,arguments);
			if(this.locpagtoID !== 0) {				
		...
		,onDestroy: function()
		{
			cadlocpagto.superclass.onDestroy.apply(this,arguments);			
			this.formPanel = null;
		}	
