var altpagpar = Ext.extend(Ext.Window,{	
		 pagparID    : 0
		,modal		 : true
		,constrain	 : true
		,maximizable : false
		...
		,constructor: function()
		{
			...
			//super
			altpagpar.superclass.constructor.apply(this, arguments);
		}
		...
		{		
			...
			//super
			altpagpar.superclass.initComponent.call(this);
		}
		,show: function()
		{
			altpagpar.superclass.show.apply(this,arguments);
			if(this.pagparID !== 0) {				
		...
		,onDestroy: function()
		{
			altpagpar.superclass.onDestroy.apply(this,arguments);			
